...
class RoomTen extends React.Component {
    constructor(props){
        super(props);
        const room_number = 10;
        this.state = {
            number: room_number,
            title: 'De cine (3/6): Tarot',
            description: 'y queroseno en 2006',
            description_2: 'Osama\'s Greatests Hits',
            expected_answer: "world trade center",
            answer: '',
            cleared: false,
